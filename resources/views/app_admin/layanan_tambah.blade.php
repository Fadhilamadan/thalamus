...
<div class="row p-t-20">
    <div class="col-sm-12">
        ...
        <div class="row">
            <form role="form" method="POST" action="{{ URL::to('/insertLayanan') }}" class="form-validation topics-list">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <select class="select2 form-control" name="m_layanan[]" id="m_layanan" multiple="multiple" data-placeholder="Pilih Layanan" required>
            ...
            <div id="modalLayanan" class="modal fade" role="dialog">
                <div class="modal-dialog">
                    <form role="form" method="POST" action="{{ URL::to('/tambahNamaLayanan') }}" class="form-validation topics-list">

...
<div class="row p-t-20">
    <div class="col-sm-12">
        ...
        <div class="row">
            <form role="form" method="POST" action="{{ URL::to('/insertPeralatan') }}" class="form-validation topics-list">
            ...
            <div id="modalPeralatan" class="modal fade" role="dialog">
                <div class="modal-dialog">
                    <form role="form" method="POST" action="{{ URL::to('/tambahNamaPeralatan') }}" class="form-validation topics-list">

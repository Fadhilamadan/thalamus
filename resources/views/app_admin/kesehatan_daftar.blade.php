                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td align="center">
                            ...
                            <form class="form-group" method="post" action="{{ url('/kesehatan_maps') }}">
                                {{ csrf_field() }}
                            ...
                            <form class="form-group" method="post" action="{{ url('/statusFaskes') }}">
                                {{ csrf_field() }}
                            ...
                            <form class="form-group" method="post" action="{{ url('/statusFaskes') }}">
                                ...
                                <button class="btn btn-icon btn-success" data-toggle="tooltip" data-placement="top" data-original-title="Aktifkan"> <i class="fa fa-undo"></i> </button>
                            </form>
                            @endif
                    ...
                    <div id="editFasKesModal{{$i}}" class="modal fade" role="dialog">
                        <div class="modal-dialog">
                            <form role="form" method="POST" action="{{ URL::to('/updateFaskes') }}" class="form-validation topics-list">

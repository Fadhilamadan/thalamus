...
<div class="row p-t-20">
    <div class="col-sm-12">
        ...
        <div class="row">
            <form role="form" method="POST" action="{{ URL::to('/updateMap') }}" class="form-validation topics-list">
                ...
                <div class="col-md-12">
                    <div class="form-group row">
                        ...
                        <div class="btn pull-right">
                            <a href="{{ URL::to('/kesehatan_daftar') }}" type="button" class="btn btn-danger waves-effect m-l-5">Kembali</a>

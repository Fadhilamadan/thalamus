...
<div class="row p-t-20">
    <div class="col-sm-12">
        ...
        <div class="row">
            <form role="form" method="POST" action="{{ URL::to('/insertDokter_super') }}" class="form-validation topics-list"> 
            ...
            <div id="modalDokter" class="modal fade" role="dialog">
                <div class="modal-dialog">
                    <form role="form" method="POST" action="{{ URL::to('/tambahNamaDokter_super') }}" class="form-validation topics-list">
            ...
            <div id="modalPenyakit" class="modal fade" role="dialog">
                <div class="modal-dialog">
                    <form role="form" method="POST" action="{{ URL::to('/tambahNamaPenyakit_super') }}" class="form-validation topics-list">
                        <div class="modal-content">
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
